...
def init_db():
    ...
    try:
        c.execute("ALTER TABLE users ADD COLUMN eco_json TEXT DEFAULT '{\"active\": false, \"level\": 1, \"integrity\": 100, \"fuel\": 1000, \"equipped\": {\"lasers\": [], \"generators\": [], \"protocols\": [], \"utility\": []}}'")
    except sqlite3.OperationalError:
        pass
