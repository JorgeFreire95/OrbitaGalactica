...
export const MODULES_CATALOG = [
  ...
  { id: 'util_repair_2', type: 'utility', lvl: 2, name: 'Robot de Reparación II RB-RP II', cost: 15000, currency: 'paladio', repair_rate: 1155, icon: '', desc: 'Robot de nanotecnología avanzada capaz de reparar daños estructurales a gran velocidad.', image: '/repair_robot_2.jpg' },
  ...
  { id: 'util_auto_repair_cpu', type: 'utility', lvl: 2, name: 'CPU de AutoReparación CPU-AR', cost: 10000, currency: 'paladio', desc: 'Inicia automáticamente a un robot de reparación disponible cuando no estás en combate.', icon: '🤖', image: '/auto_repair_cpu.png', is_auto_repair: true },
  { id: 'util_turbo_missile', type: 'utility', lvl: 2, name: 'Misil Turbo M-TRB', cost: 10000, currency: 'paladio', desc: 'Duplica la velocidad de lanzamiento de los misiles.', icon: '☄️', image: '/turbo_missile_cpu.png', is_turbo_missile: true },
  { id: 'util_auto_missile', type: 'utility', lvl: 2, name: 'CPU de Misil Automático CPU-MA', cost: 25000, currency: 'paladio', desc: 'Dispara misiles automáticamente lo más rápido posible durante un ataque.', icon: '🛰️', image: '/auto_missile_cpu.png', is_auto_missile: true },
...
export const MINERAL_TYPES = [
  ...
  { id: 'iridium',   name: 'Iridio',   color: '#cc00ff', icon: '🔮', image: '/mineral_iridium.png', stat: 'hp',   desc: 'Mejora casco base', sellPrice: 50 },
];
